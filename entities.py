...
class BinarySensorRpiPowerStatus(models.Entity):
    ...
    state = _StateClass(**{'device_class': 'problem', 'icon': 'mdi:raspberry-pi', 'friendly_name': 'RPi Power status', 'last_changed': '2024-08-03T10:45:02.208797+00:00', 'last_updated': '2024-08-03T10:45:02.208797+00:00', 'state_value': 'off'})
...
class LightLivingDownLight01(models.Entity):
    ...
    state = _StateClass(**{'min_color_temp_kelvin': 1801, 'max_color_temp_kelvin': 6535, 'min_mireds': 153, 'max_mireds': 555, 'effect_list': ['colorloop'], 'supported_color_modes': ['color_temp', 'xy'], 'effect': None, 'color_mode': 'color_temp', 'brightness': 212, 'color_temp_kelvin': 3289, 'color_temp': 304, 'hs_color': [27.409, 49.564], 'rgb_color': [255, 186, 128], 'xy_color': [0.471, 0.378], 'off_with_transition': False, 'off_brightness': None, 'friendly_name': 'living-down-light-01 Light', 'supported_features': 44, 'last_changed': '2024-08-03T10:11:02.384917+00:00', 'last_updated': '2024-08-03T10:43:02.359207+00:00', 'state_value': 'on'})
...
class SensorSunSolarElevation(models.Entity):
    ...
    state = _StateClass(**{'state_class': 'measurement', 'unit_of_measurement': '°', 'friendly_name': 'Sun Solar elevation', 'last_changed': '2024-08-03T10:43:02.131130+00:00', 'last_updated': '2024-08-03T10:43:02.131130+00:00', 'state_value': 61.08})
    services = models.Domain(
        instance=my_ha_instance,
...
class SensorSunSolarAzimuth(models.Entity):
    ...
    state = _StateClass(**{'state_class': 'measurement', 'unit_of_measurement': '°', 'friendly_name': 'Sun Solar azimuth', 'last_changed': '2024-08-03T10:43:02.132110+00:00', 'last_updated': '2024-08-03T10:43:02.132110+00:00', 'state_value': 140.92})
    services = models.Domain(
        instance=my_ha_instance,
...
class AlarmControlPanelAlarm(models.Entity):
    ...
    state = _StateClass(**{'code_format': 'number', 'changed_by': None, 'code_arm_required': False, 'message': 'alarm-manager.inactive_alarm', 'response_data': '2024-08-03T10:44:45Z', 'friendly_name': 'alarm', 'supported_features': 23, 'last_changed': '2024-07-25T11:38:55.149452+00:00', 'last_updated': '2024-08-03T10:44:47.795199+00:00', 'state_value': 'disarmed'})
...
class DeviceTrackerJoniS23(models.Entity):
    ...
    state = _StateClass(**{'source_type': 'gps', 'latitude': 41.4205064, 'longitude': 2.1577951, 'gps_accuracy': 100, 'altitude': 208, 'course': 0, 'speed': 0, 'vertical_accuracy': 100, 'friendly_name': 's23-joni', 'last_changed': '2024-08-03T10:41:53.206235+00:00', 'last_updated': '2024-08-03T10:41:53.206235+00:00', 'state_value': 'home'})
...
class LightOfficeLightsGroup(models.Entity):
    ...
    state = _StateClass(**{'min_color_temp_kelvin': 1801, 'max_color_temp_kelvin': 6535, 'min_mireds': 153, 'max_mireds': 555, 'effect_list': ['colorloop'], 'supported_color_modes': ['color_temp', 'xy'], 'effect': None, 'color_mode': 'color_temp', 'brightness': 212, 'color_temp_kelvin': 3289, 'color_temp': 304, 'hs_color': [27.409, 49.564], 'rgb_color': [255, 186, 128], 'xy_color': [0.471, 0.378], 'entity_id': ['light.office_downlight_joni', 'light.office_main_light_light_2', 'light.living_down_light_01'], 'icon': 'mdi:lightbulb-group', 'friendly_name': 'office-lights-group', 'supported_features': 44, 'last_changed': '2024-08-03T10:11:02.394672+00:00', 'last_updated': '2024-08-03T10:43:02.366302+00:00', 'state_value': 'on'})
    services = my_domains.Light(
        instance=my_ha_instance,
...
class LightAllLightsGroup(models.Entity):
    ...
    state = _StateClass(**{'min_color_temp_kelvin': 1801, 'max_color_temp_kelvin': 6535, 'min_mireds': 153, 'max_mireds': 555, 'effect_list': ['colorloop'], 'supported_color_modes': ['color_temp', 'xy'], 'effect': None, 'color_mode': 'color_temp', 'brightness': 212, 'color_temp_kelvin': 3289, 'color_temp': 304, 'hs_color': [27.409, 49.564], 'rgb_color': [255, 186, 128], 'xy_color': [0.471, 0.378], 'entity_id': ['light.living_lights_group', 'light.dining_lights_group', 'light.kitchen_main_light', 'light.galery_lights_group', 'light.bedroom_lights_group', 'light.ambient_lights_group', 'light.office_lights_group'], 'icon': 'mdi:lightbulb-group', 'friendly_name': 'all-lights-group', 'supported_features': 44, 'last_changed': '2024-08-03T10:11:02.405044+00:00', 'last_updated': '2024-08-03T10:43:02.385046+00:00', 'state_value': 'on'})
    services = my_domains.Light(
        instance=my_ha_instance,
...
class BinarySensorMacbookJoni(models.Entity):
    ...
    state = _StateClass(**{'round_trip_time_avg': 32.342, 'round_trip_time_max': 124.594, 'round_trip_time_mdev': '', 'round_trip_time_min': 4.923, 'device_class': 'presence', 'friendly_name': 'macbook-joni', 'delay_off': 1, 'last_changed': '2024-08-03T00:30:19.836051+00:00', 'last_updated': '2024-08-03T10:45:52.679959+00:00', 'state_value': 'on'})
    services = models.Domain(
        instance=my_ha_instance,
...
class SensorDateTime(models.Entity):
    ...
    state = _StateClass(**{'icon': 'mdi:calendar-clock', 'friendly_name': 'Date & Time', 'last_changed': '2024-08-03T10:46:00.002027+00:00', 'last_updated': '2024-08-03T10:46:00.002027+00:00', 'state_value': '2024-08-03, 12:46'})
    services = models.Domain(
        instance=my_ha_instance,
...
class SensorS23JoniBatteryLevel(models.Entity):
    ...
    state = _StateClass(**{'state_class': 'measurement', 'unit_of_measurement': '%', 'device_class': 'battery', 'icon': 'mdi:battery-80', 'friendly_name': 's23-joni Battery level', 'last_changed': '2024-08-03T10:41:53.326252+00:00', 'last_updated': '2024-08-03T10:41:53.326252+00:00', 'state_value': 88})
    services = models.Domain(
        instance=my_ha_instance,
...
class BinarySensorS23JoniWifi(models.Entity):
    ...
    state = _StateClass(**{'round_trip_time_avg': 277.761, 'round_trip_time_max': 389.115, 'round_trip_time_mdev': '', 'round_trip_time_min': 211.875, 'device_class': 'connectivity', 'friendly_name': 's23-joni-wifi', 'last_changed': '2024-08-03T07:42:29.742909+00:00', 'last_updated': '2024-08-03T10:45:28.088106+00:00', 'state_value': 'on'})
    services = models.Domain(
        instance=my_ha_instance,
...
class BinarySensor192168159(models.Entity):
    ...
    state = _StateClass(**{'round_trip_time_avg': 4.145, 'round_trip_time_max': 4.387, 'round_trip_time_mdev': '', 'round_trip_time_min': 3.945, 'device_class': 'connectivity', 'friendly_name': 'pixel-clau-wifi', 'last_changed': '2024-08-03T00:31:43.537631+00:00', 'last_updated': '2024-08-03T10:45:48.609535+00:00', 'state_value': 'on'})
    services = models.Domain(
        instance=my_ha_instance,
...
class SunSun(models.Entity):
    ...
    state = _StateClass(**{'next_dawn': '2024-08-04T04:15:46.947633+00:00', 'next_dusk': '2024-08-03T19:39:38.227707+00:00', 'next_midnight': '2024-08-03T23:57:27+00:00', 'next_noon': '2024-08-03T11:57:34+00:00', 'next_rising': '2024-08-04T04:47:37.285863+00:00', 'next_setting': '2024-08-03T19:07:48.891788+00:00', 'elevation': 61.08, 'azimuth': 140.92, 'rising': True, 'friendly_name': 'Sun', 'last_changed': '2024-08-03T04:48:37.358212+00:00', 'last_updated': '2024-08-03T10:43:02.129619+00:00', 'state_value': 'above_horizon'})
    services = models.Domain(
        instance=my_ha_instance,
        entity_id="sun.sun",
        state=state
